...
Retro shading does not quantize time or the height-intersection traversal. The accepted flow speeds, waves, slime bubbles, seven-step parallax and cross-currents remain intact. Unresolved native pixels fade towards the original texture's sampled mean color, so removing distant detail does not restore the brighter modern base material. Shade bands and the surface grid also fade with screen footprint to limit shimmer.
