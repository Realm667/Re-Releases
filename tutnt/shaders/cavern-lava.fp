// Generated by tools/build_cavern.py from lava-surface.fp: 1:8 skybox scale.
...
{
    vec2 world=LavaWorldPosition()*8.0;
    ...
    vec2 current=world+LavaFloorPanning()*8.0;
    vec2 top=current;
    ...
    float farDistance=length(LavaWorldPosition()-uCameraPos.xz);
