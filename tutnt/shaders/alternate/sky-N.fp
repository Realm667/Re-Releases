...
void SetupMaterial(inout Material mat)
{
 ...
 vec3 ray=normalize(vec3(s,t,-1.0)),color=RiftSurround(ray);
 ...
 rocks=RiftRockLayer(rocks,platformmap,ray,rockEye,vec3(-0.645974188,0.406736643,-0.645974188),vec3(-0.707106781,0.000000000,0.707106781),vec3(0.287606238,0.913545458,0.287606238),vec2(0.266000000,0.266000000),vec4(0.000000000,0.000000000,0.500000000,1.000000000),0.82,0.006,2.2,36000.0,-220.0);
