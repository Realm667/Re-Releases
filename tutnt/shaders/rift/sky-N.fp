...
void SetupMaterial(inout Material mat)
{
 ...
 rocks=RiftRockLayer(rocks,ray,rockEye,vec3(0.064769339,0.669130606,0.740316935),vec3(0.996194698,0.000000000,-0.087155743),vec3(-0.058318575,0.743144825,-0.666584362),vec2(0.270000000,0.320000000),vec4(0.770000000,0.430000000,0.925000000,0.746000000),0.720000000,0.014000000,5.100000000,140000.000000000,205.000000000);
 rocks=RiftRockLayer(rocks,ray,rockEye,vec3(0.785012135,0.615661475,-0.068679663),vec3(-0.087155743,0.000000000,-0.996194698),vec3(-0.613318698,0.788010754,0.053658433),vec2(0.500000000,0.480000000),vec4(0.925000000,0.430000000,0.770000000,0.746000000),0.820000000,0.016000000,3.700000000,110000.000000000,-240.000000000);
 rocks=RiftRockLayer(rocks,ray,rockEye,vec3(-0.116193310,0.743144825,-0.658965009),vec3(-0.984807753,0.000000000,0.173648178),vec3(0.129045745,0.669130606,0.731854786),vec2(0.360000000,0.480000000),vec4(0.770000000,0.430000000,0.925000000,0.746000000),0.900000000,0.018000000,1.300000000,90000.000000000,220.000000000);
 rocks=RiftRockLayer(rocks,ray,rockEye,vec3(-0.691654801,0.207911691,0.691654801),vec3(0.707106781,0.000000000,0.707106781),vec3(0.147015766,0.978147601,-0.147015766),vec2(2.666666667,1.500000000),vec4(0.000000000,0.000000000,1.000000000,1.000000000),0.720000000,0.004000000,0.000000000,55000.000000000,190.000000000);
 rocks=RiftRockLayer(rocks,ray,rockEye,vec3(-0.769751131,0.573576436,-0.280166500),vec3(-0.342020143,0.000000000,0.939692621),vec3(0.538985545,0.819152044,0.196174695),vec2(0.440000000,0.460000000),vec4(0.420000000,0.270000000,0.245000000,0.540000000),0.820000000,0.017000000,6.000000000,32000.000000000,-170.000000000);
 rocks=RiftRockLayer(rocks,ray,rockEye,vec3(0.754033432,0.390731128,0.527979893),vec3(0.573576436,0.000000000,-0.819152044),vec3(-0.320068203,0.920504853,-0.224114168),vec2(0.550000000,0.660000000),vec4(0.560000000,0.540000000,0.720000000,0.910000000),0.770000000,0.020000000,4.500000000,26000.000000000,130.000000000);
 rocks=RiftRockLayer(rocks,ray,rockEye,vec3(0.445503262,0.453990500,-0.771634285),vec3(-0.866025404,0.000000000,-0.500000000),vec3(-0.226995250,0.891006524,0.393167306),vec2(0.500000000,0.440000000),vec4(0.245000000,0.270000000,0.420000000,0.540000000),0.860000000,0.022000000,2.200000000,18000.000000000,-150.000000000);
