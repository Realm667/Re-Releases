...
def main():
 ...
 p.add_argument('--mod',type=Path,default=ROOT/'tutnt.pk3');p.add_argument('--groups',type=int,nargs='+',default=list(range(10)))
 ...
 for batch_start in range(0,len(a.groups),4):
  ...
  commands += ['save voxel-gallery','wait 6','load voxel-gallery','wait 70','netevent vxcheck','wait 8','echo UTNT_TEST_END','wait 4','quit']
