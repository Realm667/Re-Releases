...
def main():
 ...
 cmd=['wait 450','netevent sourceview 4','wait 10','netevent sourcekill','wait 55','screenshot logs/01-core-forms.png',
  ...
  'wait 58','netevent sourceimplosioncheck 4','netevent sourcedeathcheck 257 270','wait 5','screenshot logs/08-empty.png',
  'echo UTNT_TEST_END','wait 3','quit']
 r=run_case(a.engine,a.iwad,root=W,mod=a.mod,addon=ROOT/'tools/source-tests',mapname='TNT04CN',renderer=a.renderer,timeout=220,label='source-implosion',commands='; '.join(cmd),
 ...
 return 0 if r['ok'] and r['assertions']>=25 else 1
