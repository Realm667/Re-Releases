// Procedural, locally animated water surface; 2.13 and 2.0 are build constants.
...
vec4 ProcessTexel()
{
    ...
    float t=timer*2.7+2.13;
    float phase=2.0;
    float n=noise2(vec2(p.y*5.0-t,p.x*3.0+2.13));
    ...
    float grain=noise2(vec2(p.x*14.0+2.13,p.y*18.0-t*3.0));
