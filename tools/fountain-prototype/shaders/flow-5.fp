// Procedural, locally animated water surface; 16.75 and 1.0 are build constants.
...
vec4 ProcessTexel()
{
    ...
    float t=timer*2.7+16.75;
    float phase=1.0;
    float n=noise2(vec2(p.y*5.0-t,p.x*3.0+16.75));
    ...
    float grain=noise2(vec2(p.x*14.0+16.75,p.y*18.0-t*3.0));
