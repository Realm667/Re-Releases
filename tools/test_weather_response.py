...
addon=Path(__file__).resolve().parent/'weather-response-tests'
...
r=run_case(engine,iwad,root=H,mod=a.mod or H/'tutnt.pk3',addon=addon,label='response-'+kind+'-'+renderer,mapname='TNT02' if kind=='rain' else 'TNT03A1',renderer=renderer,commands=cmd,timeout=95,settings=[('weatherfx',True),('UTNT_fxquality',3),('UTNT_lod',2048),('UTNT_atmosphere',False),('motionblur',False),('con_notifytime',0),('vid_activeinbackground',True),('vid_lowerinbackground',False),('i_pauseinbackground',False)])
