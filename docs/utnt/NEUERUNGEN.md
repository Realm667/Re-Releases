...
- **Gezieltes Projektil- und Explosionsglühen:** farblich passende, weiche Leuchthöfe an Kampfobjekten und Explosionskernen; gemeinsam ein-/ausschaltbar sowie in Stärke und Größe regelbar. Berücksichtigt Effektqualität und Entfernung, erhält Originalsprites und spart Umgebung und HUD aus. [Details](UTNT_EFFECT_GLOW.md)
...
- **The Source in TNT04CN:** klarer Runenschild, sechs sich öffnende Siegelbögen, sichtbarer Kern, Schildtreffer und Guardian-Energieverbindungen; Vorzeichen für Angriffe und zerbrochene Deckenversiegelung. Finale als sichtbare Implosion: Runen, Licht und Strahl ziehen in einen schwarzen Kern, gefolgt von Lichtpunkt, Brechungsring und kombiniertem Near/Far-Implosionsklang (10.09.2026). [Details](UTNT_SOURCE.md)
