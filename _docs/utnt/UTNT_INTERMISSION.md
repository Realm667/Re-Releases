...
Body text uses a shared 1.92 scale (20% larger than the previous 1.6) for both
rendering and pagination, including the TNT04A intro. Longer passages wrap onto
additional pages; headings, navigation labels and the 2:1 column split retain
