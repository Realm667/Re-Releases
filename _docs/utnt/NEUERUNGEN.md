...
- **Sharper interface fonts:** Classic BIGFONT and Retro SMALLFONT at double resolution, with matching localized glyphs while preserving original colors, text sizes and layouts. [Details](UTNT_HIRES_FONTS.md)
