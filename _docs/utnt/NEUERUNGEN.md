...
- **Unified transitions:** shared narration, artwork and saved chapter/campaign statistics; distinct solo result plaques and cooperative comparisons with matching category icons, tied leaders and team readiness; black fades between chapters. [Details](UTNT_INTERMISSION.md)
