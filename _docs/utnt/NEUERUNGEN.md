...
- **TNT03A2 lava cavern:** clearer distance haze, brighter platform tops, organic wall and ceiling formations, irregular cliff edges, corner ribs and shoreline rocks, fissures revealing darker cavern skyboxes with matching fog, player-relative parallax and matching texture scale, a framed lava fall, luminous lava haze, drifting smoke, suspended dust and occasional ceiling grit with spatial sound; original routes and encounters preserved. [Details](UTNT_CAVERN.md)
