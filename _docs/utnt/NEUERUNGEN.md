...
- **Chapter reader:** self-paced pages, opaque chapter illustrations in a two-thirds text / one-third image layout, smooth image crossfades, original voice recordings, saved reading progress and independent cooperative reading; shared, skippable TNT04A intro. [Chapters](UTNT_UI_REFINEMENT.md), [Intro](UTNT_INTRO_CHAPTER.md)
