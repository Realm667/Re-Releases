...
- **Natural terrain edges:** raised rock skylines, material-matched rock, grass, soil and snow ledges, and selected shallow deposits at wall feet; includes upper-texture boundaries, irregular caps and overhangs, height-map detail and sector ceiling glow. [Details](UTNT_SKY_EDGES.md)
